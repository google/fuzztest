...
//
// REQUIRES: std::is_sorted(subset_indices.begin(), subset_indices.end())
// REQUIRES: For all e in subset_indices, e < set.size()
template <typename T>
...
std::string EscapeEngineFlag(std::string_view value);
