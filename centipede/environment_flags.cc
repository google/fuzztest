...
ABSL_FLAG(
    ...
    absl::StrCat(
        "The timeout to forcefully abort the test binary if it is still "
        "running after an initial SIGABRT. This is useful to prevent hangs "
        "(e.g., during stacktrace dumps). The default value is ",
        Environment::Default().force_abort_timeout, "; use 'inf' to disable."));
