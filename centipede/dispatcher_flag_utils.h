...
#ifndef FUZZTEST_CENTIPEDE_DISPATCHER_FLAG_UTILS_H_
#define FUZZTEST_CENTIPEDE_DISPATCHER_FLAG_UTILS_H_
...
struct FlagHelper {
  FlagHelper(const char *absl_nullable flags_) : flags(flags_) {}
...
#endif  // FUZZTEST_CENTIPEDE_DISPATCHER_FLAG_UTILS_H_
