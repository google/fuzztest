...
source "${CENTIPEDE_TEST_SRCDIR}/test_fuzzing_util.sh"
...
test_debug_symbols() {
  ...
  fuzztest::internal::assert_regex_in_file "FUNC: LLVMFuzzerTestOneInput .*testing/test_fuzz_target.cc:84" "${LOG}"
