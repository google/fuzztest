...
fuzztest::internal::assert_regex_in_file "usr0: [0-9]\{3,\} " "${LOG}"
fuzztest::internal::assert_regex_in_file "usr1: [0-9]\{3,\} " "${LOG}"
fuzztest::internal::assert_regex_not_in_file "usr2: " "${LOG}"
fuzztest::internal::assert_regex_not_in_file "usr3: " "${LOG}"
