...
class CentipedeCallbacks {
 ...
 private:
  ...
  // Returns an CommandContext with matching `binary`. Creates one if needed.
  ...
  // due to Command.
  std::vector<std::unique_ptr<CommandContext>> extended_commands_;
};
