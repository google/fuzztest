...
MATCHER_P(IsOkAndEquals, config, "") {
  ...
  return other.ok() && config.corpus_database == other->corpus_database &&
         ...
         config.replay_coverage_attempts == other->replay_coverage_attempts &&
         config.batch_triage_suspect_only == other->batch_triage_suspect_only &&
...
TEST(ConfigurationTest,
  ...
  Configuration configuration{"corpus_database",
                              ...
                              /*replay_coverage_attempts=*/7,
                              /*batch_triage_suspect_only=*/false,
...
TEST(ConfigurationTest,
  ...
  Configuration configuration{"corpus_database",
                              ...
                              /*replay_coverage_attempts=*/10,
                              /*batch_triage_suspect_only=*/true,
