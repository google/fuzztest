...
class FuzzingBitGen {
 ...
 private:
  ...
  inline constexpr absl::uint128 lcg(absl::uint128 s) {
  ...
  // and, if so, returns a value derived from the data_stream_.
  bool InvokeMock(MockIdType key_id, void* args_tuple, void* result);
