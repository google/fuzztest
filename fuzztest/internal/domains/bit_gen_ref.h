...
// a FuzzingBitGen instance. The generated sequences will be stable across
// executions, though it may occasionally be broken when there are changes to
// the underlying implementation such as adding support for new distributions,
// etc. This internal FuzzingBitGen instance is bound to an absl::BitGenRef
