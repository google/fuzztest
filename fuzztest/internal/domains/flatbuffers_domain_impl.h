...
//      }
//
//      static const schema_type* GetSchema(const void* buf) {
...
class FlatbuffersTableUntypedDomainImpl
 ...
 public:
  static_assert(
      ...
      Requires<FlatbuffersToolbox>([](auto toolbox) ->
                                   typename FlatbuffersToolbox::builder_type {
                                   }) &&
      ...
      Requires<FlatbuffersToolbox>(
          [](auto toolbox)
              -> decltype(toolbox.GetSchema(std::declval<const void*>())) {}) &&
      Requires<FlatbuffersToolbox>(
          [](auto toolbox)
...
class FlatbuffersTableDomainImpl
 ...
 public:
  ...
  FlatbuffersTableDomainImpl() {
    ...
    auto schema = FlatbuffersToolbox::GetSchema(T::BinarySchema::data());
    auto table_object =
