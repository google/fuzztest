...
TEST(FlatbuffersTableDomainImplTest, Printer) {
  ...
  EXPECT_THAT(out, HasSubstr("ei8: (1)"));
  EXPECT_THAT(out, HasSubstr("ei16: (1)"));
  EXPECT_THAT(out, HasSubstr("ei32: (1)"));
  EXPECT_THAT(out, HasSubstr("ei64: (1)"));
  EXPECT_THAT(out, HasSubstr("eu8: (1)"));
  EXPECT_THAT(out, HasSubstr("eu16: (1)"));
  EXPECT_THAT(out, HasSubstr("eu32: (1)"));
  EXPECT_THAT(out, HasSubstr("eu64: (1)"));
}
