...
TEST(FlatbuffersTableDomainImplTest, Printer) {
  ...
  EXPECT_THAT(out, HasSubstr("ei8: (First)"));
  EXPECT_THAT(out, HasSubstr("ei16: (First)"));
  EXPECT_THAT(out, HasSubstr("ei32: (First)"));
  EXPECT_THAT(out, HasSubstr("ei64: (First)"));
  EXPECT_THAT(out, HasSubstr("eu8: (First)"));
  EXPECT_THAT(out, HasSubstr("eu16: (First)"));
  EXPECT_THAT(out, HasSubstr("eu32: (First)"));
  EXPECT_THAT(out, HasSubstr("eu64: (First)"));
}
