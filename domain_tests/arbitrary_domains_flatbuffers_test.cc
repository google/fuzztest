...
TEST(FlatbuffersTableDomainImplTest, TypeGetters) {
...
struct FlatbuffersToolbox {
  ...
  template <typename T, typename SizeT = flatbuffers::uoffset_t>
  using vector_type = flatbuffers::Vector<T, SizeT>;
...
TEST(FlatbuffersTableDomainImplTest, VectorsSerializeAndDeserialize) {
  auto domain = internal::FlatbuffersTableDomainImpl<VectorsTestFbsTable,
                                                     FlatbuffersToolbox>{};
